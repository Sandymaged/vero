...
class CreateUserUseCaseTest extends TestCase
{
    ...
    private function mockCreateUserPresenter(&$responseModel): ICreateUserOutputPort
    {
        return tap(Mockery::mock(ICreateUserOutputPort::class), function ($mock) use (&$responseModel) {
            $mock
