<div id="kt_customers_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
    <div class="table-responsive">
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer text-center" id="kt_customers_table"
               data-delete_url="{{route($guard.'.cities.deleteAll')}}">
            <!--begin::Table head-->
            <thead>
            <!--begin::Table row-->
                ...
                <tr>
                    <td>
                        <div class="form-check form-check-sm form-check-custom form-check-solid">
                            <input class="form-check-input cell-checkbox" type="checkbox" value="1" data-id="{{$city->id}}"/>
                        </div>
                    </td>
                    <!--begin::Name=-->
                    <td>
                        <a href="#" class="text-gray-800 text-hover-primary mb-1">{{$city->name}}</a>
                    </td>
                    <!--end::Name=-->
                    <!--begin::Email=-->
                    <td>
                        <a href="#"
                           class="text-gray-600 text-hover-primary mb-1">{{optional($city->state)->name}}</a>
                    </td>
                    <td>
                        {!! getIsActive($city->is_active) !!}
                    </td>
                    <!--end::Email=-->
                    ...
                    <td>
                        ...
                        <div
                            ...
                            <div class="menu-item px-3">
                                <a href="{{route($guard.'.cities.edit', $city->id)}}" class="menu-link px-3">{{trans('messages.edit')}}</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="{{route($guard.'.cities.delete', $city->id)}}" class="menu-link px-3"
