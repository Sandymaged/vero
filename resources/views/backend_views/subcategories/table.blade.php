                    ...
                    <td>
                        ...
                        <div
                            ...
                            <div class="menu-item px-3">
                                <a href="{{route($guard.'.subcategories.edit', $subcategory->id)}}" class="menu-link px-3">{{trans('messages.edit')}}</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="{{route($guard.'.subcategories.delete', $subcategory->id)}}" class="menu-link px-3"
