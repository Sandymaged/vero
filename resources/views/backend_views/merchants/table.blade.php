...
{{--                            <input class="form-check-input cell-checkbox" type="checkbox" value="1" data-id="{{$merchant->id}}"/>--}}
{{--                        </div>--}}
{{--                    </td>--}}
{{--                    <!--end::Checkbox-->--}}
...
{{--                                    <img src="{{$merchant->logo_path}}" alt="{{$merchant->name}}"  onerror="this.src='{{asset('public/image.png')}}'"--}}
{{--                                         class="w-100">--}}
{{--                                </div>--}}
{{--                            </a>--}}
{{--                        </div>--}}
...
{{--                    <!--begin::Name=-->--}}
{{--                    <td>--}}
{{--                        <a href="#" class="text-gray-800 text-hover-primary mb-1">{{$merchant->name}}</a>--}}
{{--                    </td>--}}
{{--                    <!--end::Name=-->--}}
{{--                    <!--begin::Email=-->--}}
{{--                    <td>--}}
{{--                        <a href="#"--}}
{{--                           class="text-gray-600 text-hover-primary mb-1">{{optional($merchant->state)->name}}</a>--}}
{{--                    </td>--}}
{{--                    <td>--}}
{{--                        {!! getIsActive($merchant->is_active) !!}--}}
{{--                    </td>--}}
{{--                    <!--end::Email=-->--}}
...
{{--                                <a href="{{route($guard.'.merchants.edit', $merchant->id)}}" class="menu-link px-3">{{trans('messages.edit')}}</a>--}}
{{--                            </div>--}}
{{--                            <!--end::Menu item-->--}}
{{--                            <!--begin::Menu item-->--}}
{{--                            <div class="menu-item px-3">--}}
{{--                                <a href="{{route($guard.'.merchants.delete', $merchant->id)}}" class="menu-link px-3"--}}
