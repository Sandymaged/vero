<div id="kt_customers_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
    <div class="table-responsive">
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer text-center" id="kt_customers_table"
               data-delete_url="{{route($guard.'.roles.deleteAll')}}">
            <!--begin::Table head-->
            <thead>
            <!--begin::Table row-->
                ...
                <tr>
                    <td>
                        <div class="form-check form-check-sm form-check-custom form-check-solid">
                            <input class="form-check-input cell-checkbox" type="checkbox" value="1" data-id="{{$role->id}}"/>
                        </div>
                    </td>
                    <!--begin::Name=-->
                    <td>
                    ...
                    <!--begin::Name=-->
                    <td>
                        <a href="#" class="text-gray-800 text-hover-primary mb-1">{{$role->guard_name}}</a>
                    </td>
                    <!--end::Name=-->
                    ...
                    <td>
                        <!--begin::Update-->
                        <a class="btn btn-icon btn-active-light-primary w-30px h-30px me-3" href="{{route($guard.'.roles.edit', $role->id)}}">
                        ...
                        <!--end::Update-->
                        <!--begin::Delete-->
                        <a class="btn btn-icon btn-active-light-primary w-30px h-30px" data-kt-customer-table-filter="delete_row" href="{{route($guard.'.roles.delete', $role->id)}}">
