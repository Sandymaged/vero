<div id="kt_customers_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
    <div class="table-responsive">
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer text-center" id="kt_customers_table"
               data-delete_url="{{route($guard.'.categories.deleteAll')}}">
            <!--begin::Table head-->
            <thead>
            <!--begin::Table row-->
            ...
            @foreach($categories as $category)
                <tr>
                    ...
                    <!--begin::Name=-->
                    <td>
                        <a href="#" class="text-gray-800 text-hover-primary mb-1">{{optional($category->state)->name}}</a>
                    </td>
                    <!--end::Name=-->
                    <!--begin::Email=-->
                    <td>
                        {!! getIsActive($category->is_active) !!}
                    </td>
                    <!--end::Email=-->
