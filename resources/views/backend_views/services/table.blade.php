<div id="kt_customers_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
    <div class="table-responsive">
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer text-center" id="kt_customers_table"
               data-delete_url="{{route($guard.'.services.deleteAll')}}">
            <!--begin::Table head-->
            <thead>
            <!--begin::Table row-->
            <tr class="text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                ...
                <th class="min-w-125px">{{trans('messages.attributes.subcategory')}}</th>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-check form-check-sm form-check-custom form-check-solid">
                            <input class="form-check-input cell-checkbox" type="checkbox" value="1" data-id="{{$service->id}}"/>
                        </div>
                    </td>
                    <!--end::Checkbox-->
                    <!--begin::Name=-->
                    ...
                    <!--begin::Name=-->
                    <td>
                        <a href="#" class="text-gray-800 text-hover-primary mb-1">{{optional($service->state)->name}}</a>
                    </td>
                    <!--end::Name=-->
                    <!--begin::Name=-->
                    <td>
                        <a href="#" class="text-gray-800 text-hover-primary mb-1">{{optional($service->parent)->name}}</a>
                    </td>
                    <!--end::Name=-->
                    <!--begin::Email=-->
                    <td>
                        {!! getIsActive($service->is_active) !!}
                    </td>
                    <!--end::Email=-->
                    ...
                    <td>
                        ...
                        <div
                            ...
                            <div class="menu-item px-3">
                                <a href="{{route($guard.'.services.edit', $service->id)}}" class="menu-link px-3">{{trans('messages.edit')}}</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="{{route($guard.'.services.delete', $service->id)}}" class="menu-link px-3"
