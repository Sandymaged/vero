...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/back_end')}}/css/vendor.min.css">
    <link rel="stylesheet" href="{{asset('assets/back_end')}}/vendor/icon-set/style.css">
    <!-- CSS Front Template -->
    <link rel="stylesheet" href="{{asset('assets/back_end')}}/css/theme.minc619.css?v=1.0">
    <link rel="stylesheet" href="{{asset('assets/back_end')}}/css/toastr.css">
</head>
    ...
    <div class="container py-5 py-sm-7">
        ...
        <a class="d-flex justify-content-center mb-5" href="javascript:">
            <img class="z-index-2"  src="{{asset("storage/app/public/company/".$e_commerce_logo)}}" alt="Logo"
                 onerror="this.src='{{asset('assets/back_end/img/400x400/img2.jpg')}}'"
                 style="width: 8rem;">
        </a>
...
<script src="{{asset('assets/back_end')}}/js/vendor.min.js"></script>

<!-- JS Front -->
<script src="{{asset('assets/back_end')}}/js/theme.min.js"></script>
