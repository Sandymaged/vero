...
@section('content')
    ...
    <div class="ltn__breadcrumb-area ltn__breadcrumb-area-2 ltn__breadcrumb-color-white bg-image"
        data-bg="{{ asset('portal/assets') }}/images/inner-background/vinegar.webp">
{{--        <div class="container">--}}
{{--            <div class="row">--}}
{{--                <div class="col-lg-12">--}}
...
{{--                            </h6>--}}
{{--                            <h1 class="section-title white-color">{{ trans('messages.vinegar') }}</h1>--}}
{{--                        </div>--}}
{{--                        <div class="ltn__breadcrumb-list">--}}
{{--                            <ul>--}}
{{--                                <li><a href="/">{{ trans('messages.home') }}</a></li>--}}
{{--                                <li class="ltn__secondary-color-2">{{ trans('messages.vinegar') }}</li>--}}
{{--                            </ul>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
                            ...
                            <div class="col-xl-4 col-sm-6 col-6">
                                <div class="ltn__product-item ltn__product-item-3 text-center">
                                    <div class="product-img">
                                        <a href="{{ localeUrl('/') }}/products/roca-vinegar" class="d-block"><img
                                                src="{{ asset('portal/assets') }}/images/products/roca-vinegar/3- 233x 233/3.webp"
                                                alt="#"></a>
                                    </div>
                                    <div class="product-info">
                                        <h2 class="product-title"><a
                                                href="{{ localeUrl('/') }}/products/roca-vinegar">{{ trans('messages.roca_vinegar') }}</a>
                                        </h2>
                                    </div>
                                </div>
                            </div>
