...
@section('content')
    ...
    <div class="ltn__breadcrumb-area ltn__breadcrumb-area-2 ltn__breadcrumb-color-white bg-image"
        data-bg="{{ asset('portal/assets') }}/images/products/wivo-wafers/1.cover.png">
{{--        <div class="container">--}}
{{--            <div class="row">--}}
{{--                <div class="col-lg-12">--}}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="modal-product-info shop-details-info pl-0">
                                    <h1>{{ trans('messages.wivo_wafers') }}</h1>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="ltn__shop-details-img-gallery">
                                    <div class="ltn__shop-details-large-img">
                                        ...
                                        <div class="single-large-img">
                                            <a href="{{ asset('portal/assets') }}/images/products/wivo-wafers/4-l.png"
                                               data-rel="lightcase:myCollection">
                                                <img src="{{ asset('portal/assets') }}/images/products/wivo-wafers/4-l.png"
                                                     alt="Image">
                                            </a>
                                        </div>
                                        <div class="single-large-img">
                                            <a href="{{ asset('portal/assets') }}/images/products/wivo-wafers/5-l.png"
                                               data-rel="lightcase:myCollection">
                                                <img src="{{ asset('portal/assets') }}/images/products/wivo-wafers/5-l.png"
                                                     alt="Image">
                                            </a>
                                        </div>
                                        <div class="single-large-img">
                                            <a href="{{ asset('portal/assets') }}/images/products/wivo-wafers/6-l.png"
                                               data-rel="lightcase:myCollection">
                                                <img src="{{ asset('portal/assets') }}/images/products/wivo-wafers/6-l.png"
                                                     alt="Image">
                                            </a>
                                        </div>
                                        {{-- <div class="single-large-img">
                                    ...
                                    <div class="ltn__shop-details-small-img slick-arrow-2">
                                        ...
                                        <div class="single-small-img">
                                            <img src="{{ asset('portal/assets') }}/images/products/wivo-wafers/4.png"
                                                 alt="Image">
                                        </div>
                                        <div class="single-small-img">
                                            <img src="{{ asset('portal/assets') }}/images/products/wivo-wafers/5.png"
                                                 alt="Image">
                                        </div>
                                        <div class="single-small-img">
                                            <img src="{{ asset('portal/assets') }}/images/products/wivo-wafers/6.png"
                                                 alt="Image">
                                        </div>
                                        {{-- <div class="single-small-img">
                                            <img src="{{ asset('portal/assets') }}/images/products/wivo/4.png"
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade active show" id="liton_tab_details_1_1">
                                <div class="ltn__shop-details-tab-content-inner">
                                    ...
                                    <p>
                                        {{ trans('messages.wivo_wafers_description') }}
                                    </p>
                                    {{-- <p>
