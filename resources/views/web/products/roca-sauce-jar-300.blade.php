                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="modal-product-info shop-details-info pl-0">
                                    <h1>{{ trans('messages.roca_sauce_jar_300_gm') }}</h1>
                                </div>
                            </div>
                            <div class="col-md-12">
                                        ...
                                        <div class="single-large-img" style="text-align: center;">
                                            <a href="{{ asset('portal/assets') }}/images/products/roca-sauce/770×600px/300-jar.webp"
                                                ...
                                                <img src="{{ asset('portal/assets') }}/images/products/roca-sauce/770×600px/300-jar.webp"
                                                    alt="{{ trans('messages.roca_sauce_jar_300_gm') }}"
                                                    style="width: auto !important">
                                                <span>
                                                    {{ trans('messages.roca_sauce_jar_300_gm') }}
                                                </span>
                                            </a>
                                        </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade active show" id="liton_tab_details_1_1">
                                <div class="ltn__shop-details-tab-content-inner">
                                    ...
                                    <p>
                                        ROCA Tomato Puree 360 gm<br>
                                        Net weight approximately: 360 gm / jar<br>
                                        Packaging: Jar<br>
                                        Carton includes 12 jars
                                    </p>
                                    {{-- <p>
