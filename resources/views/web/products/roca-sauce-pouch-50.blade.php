                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="modal-product-info shop-details-info pl-0">
                                    <h1>{{ trans('messages.roca_sauce_pouch_50_gm') }}</h1>
                                </div>
                            </div>
                            <div class="col-md-12">
                                        ...
                                        <div class="single-large-img" style="text-align: center;">
                                            <a href="{{ asset('portal/assets') }}/images/products/roca-sauce/770×600px/50.webp"
                                                ...
                                                <img src="{{ asset('portal/assets') }}/images/products/roca-sauce/770×600px/50.webp"
                                                    alt="{{ trans('messages.roca_sauce_pouch_50_gm') }}"
                                                    style="width: auto !important">
                                                <span>
                                                    {{ trans('messages.roca_sauce_pouch_50_gm') }}
                                                </span>
                                            </a>
                                        </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade active show" id="liton_tab_details_1_1">
                                <div class="ltn__shop-details-tab-content-inner">
                                    ...
                                    <p>
                                        ROCA Tomato Puree 50 gm<br>
                                        Net weight approximately: 50 gm / pouch<br>
                                        Packaging: Pouch<br>
                                        No. of pouches on box: 24 pouches<br>
                                        No. of boxes on carton: 4 boxes<br>
                                        Total no. of pouches on carton: 96 pouches
                                    </p>
                                    {{-- <p>
