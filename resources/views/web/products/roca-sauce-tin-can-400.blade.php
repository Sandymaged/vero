                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="modal-product-info shop-details-info pl-0">
                                    <h1>{{ trans('messages.roca_sauce_tin_can_400_gm') }}</h1>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="ltn__shop-details-img-gallery">
                                        ...
                                        <div class="single-large-img" style="text-align: center;">
                                            <a href="{{ asset('portal/assets') }}/images/products/roca-sauce/770×600px/400.webp"
                                                ...
                                                <img src="{{ asset('portal/assets') }}/images/products/roca-sauce/770×600px/400.webp"
                                                    alt="{{ trans('messages.roca_sauce_tin_can_400_gm') }}"
                                                    style="width: auto !important">
                                                <span>
                                                    {{ trans('messages.roca_sauce_tin_can_400_gm') }}
                                                </span>
                                            </a>
                                        </div>

                                        <div class="single-large-img" style="text-align: center;">
                                            <a href="{{ asset('portal/assets') }}/images/products/roca-sauce/770×600px/400-s.webp"
                                                data-rel="lightcase:myCollection">
                                                <img src="{{ asset('portal/assets') }}/images/products/roca-sauce/770×600px/400-s.webp"
                                                    alt="{{ trans('messages.roca_sauce_tin_can_400_gm') }}"
                                                    style="width: auto !important">
                                                <span>
                                                    {{ trans('messages.roca_sauce_tin_can_400_gm') }}
                                    ...
                                    <div class="ltn__shop-details-small-img slick-arrow-2">
                                        ...
                                        <div class="single-small-img">
                                            <img src="{{ asset('portal/assets') }}/images/products/roca-sauce/183×183px/400-s.webp"
                                                alt="Image">
                                        </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade active show" id="liton_tab_details_1_1">
                                <div class="ltn__shop-details-tab-content-inner">
                                    ...
                                    <p>
                                        ROCA Tomato Puree 400 gm<br>
                                        Net weight approximately: 400 gm / Tin Can<br>
                                        Packaging: Tin Can<br>
                                        Carton includes 24 Tin Cans
                                    </p>
                                    {{-- <p>
