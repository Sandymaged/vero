                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="modal-product-info shop-details-info pl-0">
                                    <h1>{{ trans('messages.roca_bbq_sauce') }}</h1>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="ltn__shop-details-img-gallery">
                                    <div class="ltn__shop-details-large-img">
                                        ...
                                        <div class="single-large-img" style="text-align: center;">
                                            <a href="{{ asset('portal/assets') }}/images/products/roca-sauces/770×600px/bbq.webp"
                                                data-rel="lightcase:myCollection">
                                                <img src="{{ asset('portal/assets') }}/images/products/roca-sauces/770×600px/bbq.webp"
                                                    alt="{{ trans('messages.roca_bbq_sauce_310') }}"
                                                    style="width: auto !important">
                                                <span>
                                                    {{ trans('messages.roca_bbq_sauce_310') }}
                                                </span>
                                            </a>
                                        </div>
                                    ...
                                    <div class="ltn__shop-details-small-img slick-arrow-2">
                                        ...
                                        <div class="single-small-img">
                                            <img src="{{ asset('portal/assets') }}/images/products/roca-sauces/183×183px/bbq.webp"
                                                alt="Image">
                                        </div>
