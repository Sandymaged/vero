                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="modal-product-info shop-details-info pl-0">
                                    <h1>{{ trans('messages.roca_sauce_pouch_300_gm') }}</h1>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="ltn__shop-details-img-gallery">
                                        ...
                                        <div class="single-large-img" style="text-align: center;">
                                            <a href="{{ asset('portal/assets') }}/images/products/roca-sauce/770×600px/300.webp"
                                                ...
                                                <img src="{{ asset('portal/assets') }}/images/products/roca-sauce/770×600px/300.webp"
                                                    alt="{{ trans('messages.roca_sauce_pouch_300_gm') }}"
                                                    style="width: auto !important">
                                                <span>
                                                    {{ trans('messages.roca_sauce_pouch_300_gm') }}
                                                </span>
                                            </a>
                                        </div>
                                        <div class="single-large-img" style="text-align: center;">
                                            <a href="{{ asset('portal/assets') }}/images/products/roca-sauce/770×600px/300-s.webp"
                                                data-rel="lightcase:myCollection">
                                                <img src="{{ asset('portal/assets') }}/images/products/roca-sauce/770×600px/300-s.webp"
                                                    alt="{{ trans('messages.roca_sauce_pouch_300_gm') }}"
                                                    style="width: auto !important">
                                                <span>
                                                    {{ trans('messages.roca_sauce_pouch_300_gm') }}
                                    ...
                                    <div class="ltn__shop-details-small-img slick-arrow-2">
                                        ...
                                        <div class="single-small-img">
                                            <img src="{{ asset('portal/assets') }}/images/products/roca-sauce/183×183px/300-s.webp"
                                                alt="Image">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade active show" id="liton_tab_details_1_1">
                                <div class="ltn__shop-details-tab-content-inner">
                                    ...
                                    <p>
                                        ROCA Tomato Puree 300 gm<br>
                                        Net weight approximately: 300 gm / pouch<br>
                                        Packaging: Stand up pouch<br>
                                        Carton includes 24 pouches<br>
                                    </p>
                                    {{-- <p>
