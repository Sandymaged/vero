<div data-kt-menu-trigger="click"
     class="menu-item menu-accordion {{ Request::is($guard.'/specialists*') || Request::is($guard.'/vacations*') ? 'here hover show' : '' }}">
											<span class="menu-link">
												<span class="menu-icon">

                                                    <span class="svg-icon svg-icon-muted svg-icon-2"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Code/Time-schedule.svg--><svg
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path
            ...
            fill="#000000" opacity="0.3"/>
												...
												<span
                                                    class="menu-title">{{trans('messages.attributes.reservation_settings')}}</span>
												<span class="menu-arrow"></span>
											</span>
    <div class="menu-sub menu-sub-accordion menu-active-bg">
        <div class="menu-item">
            <a class="menu-link {{ Request::is($guard.'/specialists*') ? 'active' : '' }}"
               href="javascript:">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
                <span class="menu-title">{{trans('messages.attributes.table')}}</span>
            </a>
        </div>
        <div class="menu-item">
            <a class="menu-link {{ Request::is($guard.'/vacations*') ? 'active' : '' }}"
               href="javascript:">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
                <span class="menu-title">{{trans('messages.attributes.vacations')}}</span>
            </a>
        </div>
    </div>
</div>
