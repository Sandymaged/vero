...
<span class="svg-icon svg-icon-muted svg-icon-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
												...
												<span
                                                    class="menu-title">{{trans('messages.attributes.settings')}}</span>
