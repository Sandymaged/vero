...
// Search Datatable --- official docs reference: https://datatables.net/reference/api/search()
        ...
        var handleResetForm = () => {
            ...
            resetButton.addEventListener('click', function () {
                ...
                $("select.filter-input").val(null).trigger('change');
        ...
        var initCustomerList = function () {
            var table = document.querySelector('#kt_customers_table');

            initToggleToolbar();
            handleSearchDatatable();
            handleDeleteRows();

            let url = typeof ajaxUrl === 'undefined' ? '' : ajaxUrl;

            let columnDefs = typeof dataColumnDefs === 'undefined' ? [] : dataColumnDefs;

            let filters = typeof dataFilters === 'undefined' ? [] : dataFilters;

            let columns = typeof dataColumns === 'undefined' ? [] : dataColumns;
